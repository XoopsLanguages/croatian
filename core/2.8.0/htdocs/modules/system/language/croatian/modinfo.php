...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Omogući administraciju jezika');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Upravljajte registrom lokalizacija, jezičnim paketima, provjerama ispravnosti i zamjenama prijevoda web-mjesta.');
define('_MI_SYSTEM_BNAME14', 'Prebacivač jezika');
