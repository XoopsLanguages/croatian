...
define('MENUS_HOME', 'Početna');
define('MENUS_ADMIN', 'Administracija');
define('MENUS_ACCOUNT', 'Račun');
define('MENUS_ACCOUNT_EDIT', 'Uredi račun');
define('MENUS_ACCOUNT_LOGIN', 'Prijava');
define('MENUS_ACCOUNT_LOGOUT', 'Odjava');
define('MENUS_ACCOUNT_REGISTER', 'Registracija');
define('MENUS_ACCOUNT_MESSAGES', 'Poruke');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Obavijesti');
define('MENUS_ACCOUNT_TOOLBAR', 'Alatna traka');
